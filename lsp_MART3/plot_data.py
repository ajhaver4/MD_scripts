...
ax[1].plot(timesteps_array,data['memb_minA'],label='Memb_resid_A',color='darkorchid',linewidth=0.6)
ax[1].plot(timesteps_array,data['memb_minB'],label='Memb_resid_B',color='plum',linewidth=0.6)
ax[2].set_xlabel("Time $\mu$s",fontsize=25)
ax[0].set_ylabel("nm")
ax[1].set_ylabel("nm")
ax[2].set_ylabel("nm",fontsize=25)
ax[0].legend()
ax[1].legend()
ax[2].legend()
...
ax3[0].plot(timesteps_array,data['RMSD-A'],label="RMSD-A",linewidth=0.6,color='olive')
ax3[0].plot(timesteps_array,data['RMSD-B'],label='RMSD-B',linewidth=0.6,color='gold')
# ax3[1].plot(timesteps_array,data['membdist'],label='Dist b/w memb patches',linewidth=0.6,color='orchid')
ax3[1].plot(timesteps_array,data['MinProDist'],label='Dist b/w Proteins',linewidth=0.6,color='orchid')
...
fig3,ax3 = plt.subplots(2,1)
ax3[0].plot(timesteps_array,data['comA'],label="COM-A (z)",linewidth=0.6,color='olive')
ax3[1].plot(timesteps_array,data['comB'],label='COM-B (z)',linewidth=0.6,color='purple')
ax3[0].legend()
ax3[1].legend()
ax3[1].set_xlabel("Time $\mu$s")
ax3[0].set_ylabel("nm")
