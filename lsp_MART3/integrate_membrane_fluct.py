...
hist_pitchA = p5A
data_pitchA = data['PitchA5'][threshold]
mask1 = np.nonzero(hist_pitchA[0])
avg_pitch = np.mean(data_pitchA)
...
hist_pitchB = p4B
data_pitchB = data['PitchB3'][threshold]
mask2 = np.nonzero(hist_pitchB[0])
avg_pitchB = np.mean(data_pitchB)
...
params_02B = curve_fit(harm,x_data1,y_data1,[100,90],maxfev=800,bounds=(1.0,2000))
...
params_02B = curve_fit(harm,x_data2,y_data2,[110,43],maxfev=10000)
