...
with open("../Final_parameter_data.txt",'a') as fl1:
    fl1.write("#Frame\tTimestep\tmin_dist\tmin_dist_A\tmemb_minA\tcomA\tzangle_A\tdelta_z_A\tlipid_count\n")
...
with open("../Delta_Z_measurements.txt",'a') as fl1:
    fl1.write("#Frame\tTimestep\tcomA\tdelta_z_A\tz_A_hi\tz_A_low\tz_A_med\tz_A_membres\n")
    for i in range(n_frames):
        fl1.write(str(i))
        fl1.write("\t")
        fl1.write(str(u_copy.trajectory[i].time))
...
with open("../Pitch_Roll_measurements.txt", 'a') as fl2:
    fl2.write("#Frame\tTimestep\tZ_angle_A\tPitchA1\tPitchA2\tPitchA3\tPitchA4\tRollA1\tRollA2\tRollA3\tRollA4\tRollA5\n")
    for i in range(n_frames):
        fl2.write(str(i))
        fl2.write("\t")
